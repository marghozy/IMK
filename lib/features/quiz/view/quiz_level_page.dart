      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.xl),
            Text('📚 PILIH LEVEL', style: AppTextStyles.labelUppercase),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: info.locked ? const Icon(Icons.lock_rounded, color: AppColors.inkMuted) : Text(emoji, style: const TextStyle(fontSize: 22)),
                  ),
                  const SizedBox(width: AppSpacing.md),
                  Expanded(
                    child: Column(
